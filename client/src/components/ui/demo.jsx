...
export default function Demo() {
    return (
        <div className="w-full max-w-[500px] border-b border-gray-300 space-y-4 p-3 text-gray-500 text-sm">
            <div className="flex justify-between items-center">
                <div className="flex items-center gap-1">
                    <img className="h-8 w-8 mr-2 rounded-full" src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=50" alt="userImage1" />
            ...
            <p>&ldquo;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna&rdquo;</p>
            <div>
