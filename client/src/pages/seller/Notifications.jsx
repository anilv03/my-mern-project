...
import { formatDate, getTimeAgo, classNames } from '../../lib/helpers';

const NOTIF_ICONS = {
  new_order: 'M9 5l7 7-7 7',
  ...
  product_rejected: 'M12 9v2m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
...
export default function SellerNotifications() {
  ...
  return (
    <>
      <Helmet><title>Notifications | Seller | Zalnio</title></Helmet>
        ...
        {isLoading ? (
          ...
          <div className="space-y-2">
            {filtered.map(notif => {
              ...
              return (
                <Card key={notif._id} padding={false} hover={false}
                  className={classNames('transition-colors', !notif.isRead && 'bg-primary-50/50 border-primary-100')}>
                  <div className="flex items-start gap-4 p-4">
                    <div className={classNames('w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0', colorClass)}>
                    ...
                    <div className="flex-1 min-w-0" onClick={() => !notif.isRead && handleMarkRead(notif._id)}>
                      <div className="flex items-start justify-between">
                        <div>
                          <p className={classNames('text-sm', !notif.isRead ? 'font-semibold text-gray-900' : 'text-gray-700')}>{notif.title}</p>
